...
class Home extends Component {
    ...
    render () {
        ...
        if( this.state.packagePage === true ) {
            return<Redirect to={this.state.url + this.state.continent} />
        }
                            ...
                            <div className="form-inline d-flex">
                                <input
                                   ...
                                   // onKeyDown={this.onKeyDown}
                                    ...
                                    placeholder="Where?"
                                />&nbsp;
                    <button className="btn btn-primary mx-auto fa fa-search" type="submit" onClick={this.handleSearch}  >Search</button>
                            ...
                            <div className="col-md-4 mb-3 mb-md-0">
                                <div className="card py-4 h-100">
                                    <div className="card-body text-center">
                                        ...
                                        <hr className="my-4" />
                                        <div className="small text-black-50">Patna,Bihar</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-md-4 mb-3 mb-md-0">
                                <div className="card py-4 h-100">
                                    <div className="card-body text-center">
                                        ...
                                        <hr className="my-4" />
                                        <div className="small text-black-50"><Link to="/home">akanksha.angel822@gmail.com</Link></div>
                                    </div>
                                </div>
                            </div>
