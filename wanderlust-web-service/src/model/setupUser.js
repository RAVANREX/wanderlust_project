...
const destinationData = [
  {
    destinationId: 'D1001',
    continent: 'Europe',
    imageUrl: '/assets/europepic2.jpg',
  ...
  },
  {
    destinationId: 'D1002',
    continent: 'Europe',
    imageUrl: '/assets/europepic1.jpg',
  ...
  },
  {
    ...
    imageUrl: '/assets/europepic3.jpg',
    details: {
  ...
  },
  {
    ...
    imageUrl: '/assets/europepic4.jpg',
    details: {
  ...
  },
  {
    ...
    imageUrl: '/assets/australiapic.jpg',
    details: {
  ...
  },
  {
    ...
    imageUrl: '/assets/australiapic2.jpg',
    details: {
  ...
  },
  {
    ...
    imageUrl: '/assets/singaporepic.jpg',
    details: {
...
const hotDealsData = [
  {
    ...
    imageUrl: '/assets/thailandpic.jpg',
    details: {
           ...
           return myCollection.deleteMany().then( () => {
                return myCollection.insertMany( userData ).then( () => {
                  return connection.getBookingsCollection().then( ( myCollection ) => {
                          return myCollection.deleteMany().then( (  ) => {
                            return myCollection.insertMany( bookData ).then( (  ) => {
                              return connection.getDestinationsCollection().then( ( myCollection ) => {
                                     return myCollection.deleteMany().then( ( ) => {
                                       return myCollection.insertMany( destinationData ).then( ( ) => {
